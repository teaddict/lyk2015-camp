...
public class WebConfig extends WebMvcConfigurerAdapter {
	...
	@Autowired
	@Bean(name = "sessionFactory") // isim vermezsek method ismini default
									// olarak alıyor ve dependecy poolda o
									// isimde arıyor nesne
	public SessionFactory getSessionFactory(DataSource dataSource) {

		LocalSessionFactoryBuilder sessionBuilder = new LocalSessionFactoryBuilder(dataSource);

		sessionBuilder.scanPackages("tr.org.lkd.lyk2015.camp.model"); // entitylere
																		// bakıyor
	...
	private Properties getHibernateProperties() {
		...
		properties.put("hibernate.dialect", "org.hibernate.dialect.PostgreSQLDialect"); // burda
																						// database
																						// tipini
																						// girmemiz
																						// gerek
		...
		properties.put("hibernate.use_sql_comments", "true"); // açıklama
																// ekliyor
